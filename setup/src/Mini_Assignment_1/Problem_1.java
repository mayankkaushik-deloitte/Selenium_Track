...
public class Problem_1 {
    public static void main(String[] args) {
        ...
        driver.findElement(By.className("theme-btn theme-btn-small waves-effect")).click();
        driver.findElement(By.xpath("//a[text()='Signup' and @class='theme-btn theme-btn-small waves-effect']"));
    }
}
